...
```bash
rm -rf REPO_ROOT/antigravity/<plugin>/skills/<skill>/
```
...
Remove the row for `<skill>` from the skills table in `antigravity/<plugin>/README.md`.
...
Deleted:
  antigravity/<plugin>/skills/<skill>/
