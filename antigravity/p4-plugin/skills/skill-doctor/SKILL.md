...
skills_dir = f"{REPO_ROOT}/antigravity/{plugin_name}/skills"
```
...
For each skill directory found under `antigravity/<plugin>/skills/`:
...
No other fields are required for Antigravity CLI. Fields like `version`, `allowed-tools`, `argument-hint` are NOT expected and should not be flagged as missing.
...
The version in `antigravity/<plugin>/plugin.json` should match `plugin_entry["version"]` in catalog.json.
...
```
══════════════════════════════════════════════════════════════════════
  SKILL DOCTOR: <plugin>  (Antigravity CLI)
══════════════════════════════════════════════════════════════════════
