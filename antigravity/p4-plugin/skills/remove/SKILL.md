...
# Plugin Remover (Antigravity CLI)
...
⚠️  This will permanently delete:
  ...
  antigravity/<plugin>/      (plugin directory and all skills)
...
```bash
rm -rf REPO_ROOT/antigravity/<plugin>/
...
Next steps:
  ...
  2. Uninstall from Antigravity: remove ~/.gemini/config/plugins/<plugin>/
```
