...
Plugin lifecycle management for Antigravity CLI. Create, update, remove, and audit plugins and skills in the plugin4ai marketplace.
...
- This port manages plugins under `antigravity/<plugin>/` in the repo
- Install command: `agy plugin install <path>`
- Plugin files are stored at `~/.gemini/config/plugins/<plugin>/`
