# Codex CLI/TUI Marketplace

This directory contains plugin ports for OpenAI Codex CLI/TUI.
...
- **Storage paths**: `~/.p4/` (universal, shared across CLIs), `~/.codex/plugins/` (codex plugin cache).
