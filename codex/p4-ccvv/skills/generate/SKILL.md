---
name: generate
description: Generates an adapted CV draft for a specific job position. Analyzes the job offer, extracts keywords, and creates a markdown draft ready for review and export.
---
...
Ask the user (via plain text) to provide:
