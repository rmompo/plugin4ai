...
Check that `codex/<plugin>/README.md` exists.
...
`codex/<plugin>/README.md` must contain:
- A top-level heading with the plugin name
- A `## Skills` section
- An `## Installation` section (with `codex /plugins` instructions)
...
══════════════════════════════════════════════════════════════════════
  ...
  ✅ D5 README exists: codex/<plugin>/README.md
