---
name: skill-add
description: Adds a new skill to an existing GitHub Copilot plugin. Creates the SKILL.md, increments the Z version counter in catalog.json, and updates plugin.json and README.md. Also invoked explicitly as /p4-plugin:skill-add with plugin and skill name.
---

# Skill Adder (GitHub Copilot)
...
Add a row to the skills table in `ghcopilot/plugins/<plugin>/README.md`.
