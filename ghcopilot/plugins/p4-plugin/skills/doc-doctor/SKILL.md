...
Check that `ghcopilot/plugins/<plugin>/README.md` exists.
...
`ghcopilot/plugins/<plugin>/README.md` must contain:
- A top-level heading with the plugin name
- A `## Skills` section
...
```
══════════════════════════════════════════════════════════════════════
  DOC DOCTOR: <plugin>  (GitHub Copilot)
══════════════════════════════════════════════════════════════════════
  ...
  ✅ D5 README exists: ghcopilot/plugins/<plugin>/README.md
  ⚠️  D6 README sections: missing ## Skills
