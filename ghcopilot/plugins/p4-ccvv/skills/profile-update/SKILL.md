...
Read `~/.p4/p4-ccvv/profiles.json`. Use **ask_user** to select the profile to update.
...
Collect field values via **ask_user**. Never modify fields not explicitly requested.
