...
version: 2
description: Loads and activates P4D behavioral directives for the session. Fires automatically at session start via the p4-core agent. Also invoked explicitly as /p4-core:model-behaviour to inspect or reload directives.
trigger: session-start
allowed-tools: [Bash]
---

# P4D — Behavioral Directives (Claude Code port)
